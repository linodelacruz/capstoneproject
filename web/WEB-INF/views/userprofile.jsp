...
<html>
    ...
    <body>
        ...
        <div class="coverpadx"><img src="/cramazin/coverimage?id=${globaluserprofile.coverphotoid}" style="height: 350px; width: 850px" alt="cover"></div>
        <div class="profilepic"></div>
        <div class="profilepicx"><img src="/cramazin/profileimage?id=${globaluserprofile.profileimageid}" style="height: 140px;" alt="profile pic"></div>
        <div class="username">${globaluserprofile.firstname}&nbsp;${globaluserprofile.lastname}</div>
        ...
        <div class="postp">
            <div id="column-1" class="postp"><a href="#" style="text-decoration: none;">Write a post</a><hr><br><br><br></div>
            <form action="/cramazin/userpost" method="POST" enctype="multipart/form-data">        
                ...
                <div id="postboxpos" class="postp"><textarea placeholder="Write something on ${globaluserprofile.firstname}'s timeline" id="postbox" name="postedtext"></textarea></div>
            </form>
        </div>
        ...
        <div class="aboutpad">
            ...
            <br>
            <h3>My info:</h3>
            <p><b>Location:</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp&nbsp&nbsp&nbsp ${userprofile.zipcode}</p>            
            <p><b>User Name:</b> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp${globaluserprofile.username}</p>
            <p><b>Registered email:</b> &nbsp&nbsp${globaluserprofile.useremail}</p>
